      ...
      >
        <div className="flex items-center gap-4 md:gap-10">
          ...
          <div className="hidden gap-4 md:flex">
            <span className="text-sm hover:text-gray-400 transition duration-200">Home</span>
            <span className="text-sm text-gray-400 hover:text-white transition duration-200">TV Shows</span>
            <span className="text-sm text-gray-400 hover:text-white transition duration-200">Movies</span>
            <span className="text-sm text-gray-400 hover:text-white transition duration-200">New & Popular</span>
            <span className="text-sm text-gray-400 hover:text-white transition duration-200">My List</span>
          </div>
        </div>
